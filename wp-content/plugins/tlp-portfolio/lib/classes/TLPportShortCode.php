...
if (!class_exists('TLPportShortCode')):
    ...
    class TLPportShortCode
    {
        ...
        function portfolio_shortcode($atts, $content = "") {
            ...
            if ($teamQuery->have_posts()) {
                ...
                while ($teamQuery->have_posts()) : $teamQuery->the_post();
                    ...
                    $price = get_post_meta($iID, 'price', true);
        ...
        function templateOne($itemArg) {
            extract($itemArg);
            $html = null;
			$html .= '<center><div class="pro-col" style="padding-bottom: 10px"><div class="pro-box">';
			$html .= '<div class="img-box"><a href="' . $plink . '"><img src="'.$imgFull.'"></a><a href="http://www.w185.webyfix.com/wby/order-form/"><div class="img-over">Buy Now</div></a></div>';
			$html .= '<a href="' . $plink . '"><h2>'.$title.'</h2></a>';
