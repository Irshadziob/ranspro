...
if(!class_exists('PortfolioPostTypeRegistrations')):
	...
	class PortfolioPostTypeRegistrations {
		...
		protected function register_post_type() {
			global $TLPportfolio;
			$labels = array(
				'name'               => __( 'Products', 'tlp-portfolio' ),
				'singular_name'      => __( 'Product', 'tlp-portfolio' ),
				'add_new'            => __( 'Add Product', 'tlp-portfolio' ),
				'all_items'          => __( 'All Product', 'tlp-portfolio'),
				'add_new_item'       => __( 'Add Product', 'tlp-portfolio' ),
				'edit_item'          => __( 'Edit Product', 'tlp-portfolio' ),
				'new_item'           => __( 'New Product', 'tlp-portfolio' ),
				'view_item'          => __( 'View Product', 'tlp-portfolio' ),
				'search_items'       => __( 'Search Product', 'tlp-portfolio' ),
				'not_found'          => __( 'No Product found', 'tlp-portfolio' ),
				'not_found_in_trash' => __( 'No Product in the trash', 'tlp-portfolio' ),
			);
			$supports = array(
				'title',
				'editor',
