...
if (!class_exists('TPLshortCode')):
    ...
    class TPLshortCode
    {
        ...
        function team_shortcode($atts) {
            ...
            if ($teamQuery->have_posts()) {
				...
				$position = get_post_meta(get_the_ID(), 'position', true);
                    ...
                    switch ($atts['layout']) {
                        case 1:
                            $html .= $this->layoutOne($title, $pLink, $imgSrc, $position, $facebook, $twitter, $instagram);
                            break;
        ...
        function layoutOne($title, $pLink, $imgSrc, $position, $facebook, $twitter, $instagram) {
            global $TLPteam;
            $settings = get_option($TLPteam->options['settings']);
            $html = null;
			
						 $html .= '<div class="gallcol">';
			 $html .= '<a class="tlp-zoom" href="' . $imgSrc . '"><div class="gallbox">';
			
			
			
			$html .= '<div class="container1">
  <img src="'.$imgSrc.'" class="image1">
  <div class="overlay1">
